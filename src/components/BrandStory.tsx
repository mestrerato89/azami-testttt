      ...
      <div className="container mx-auto px-5 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-24 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}
            ...
            <div className="absolute -bottom-3 -right-3 md:-bottom-4 md:-right-4 w-full h-full border border-primary/15 -z-10" />
          </motion.div>

          {/* Text */}
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }}>
            <p className="font-body text-[9px] md:text-[10px] tracking-[0.4em] uppercase text-primary mb-4">Nossa Essência</p>
            <h2 className="font-display text-3xl md:text-5xl font-light text-foreground leading-tight mb-6 md:mb-8">
              Vista a sua<br /><span className="italic text-gold-gradient">melhor versão</span>
            </h2>
            ...
            <div className="mb-6">
              <svg width="80" height="16" viewBox="0 0 80 16" fill="none" className="text-primary/25">
