          ...
          >
            ...
            <div className="space-y-5">
              ...
              <p className="font-body text-sm text-muted-foreground leading-relaxed">
                ...
                Porque moda é sobre como você se sente.
              </p>
            </div>

            {/* Decorative SVG: stylized thread/stitch pattern representing craftsmanship */}
            <div className="mt-10 mb-8">
              <svg width="120" height="24" viewBox="0 0 120 24" fill="none" className="text-primary/30">
                <path
            ...
            <a
              href="#"
              className="font-body text-[11px] tracking-[0.2em] uppercase text-foreground border-b border-foreground/30 hover:border-primary hover:text-primary pb-1 transition-colors duration-300"
            >
